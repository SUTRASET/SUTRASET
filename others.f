...
3      FORMAT('INITIAL WATER STORAGE IS (KG)',27X,'[WMAI]:'
     ...
     2,'TOTAL PRESSURE BOUNDARY IN(+)/OUT(-) IS (KG)',12X,'[QPT]:'
     2,2X,1PE15.8,/
     3,'TOTAL WATER SOURCE(+)/SINK(-) BOUDARY IS (KG) [QST]  :'
     4,2X,1PE15.8,/
     1,'WATER STORAGE DIFF. GAIN(+)/LOSS(-) IS (KG)   [WSDI=WMAF-WMAI]:'
     1,2X,1PE15.8,/
     1,'TOTAL WATER GAIN(+)/LOSS(-) FROM BDY. IS (KG) [QS=QSI+QPI] :'
     1,2X,1PE15.8,/
     4,'ABSOLUTE MASS DIF. BTW STORAGE AND IN&OUT [QS-WSDI ]:'
     2,2X,1PE15.8,/
...
4      FORMAT('INITIAL SOLUTE STORAGE IS (KG)',17X,':',2X,1PE15.8,/
     6,'FINAL SOLUTE STORAGE IS (KG)',19X,':',2X,1PE15.8,/
     2,'TOTAL PRESSURE BOUNDARY IN(+)/OUT(-) IS (KG)   :',2X,1PE15.8,/
     3,'TOTAL SOLUTE SOURCE(+)/SINK(-) BOUDARY IS (KG) :',2X,1PE15.8,/
     1,'SOLUTE STORAGE DIFF. GAIN(+)/LOSS(-) IS (KG)   :',2X,1PE15.8,/
     1,'TOTAL SOLUTE GAIN(+)/LOSS(-) FROM BDY. IS (KG) :',2X,1PE15.8,/
     4,'ABSOLUTE MASS DIF. BTW STORAGE AND IN&OUT      :',2X,1PE15.8,/
     5,'RELATIVE MASS DIF. BTW STORAGE AND IN&OUT      :',2X,1PE15.8,/)
