...
C                                                                        BCTIME........1100
     ...
     2   PM1,UM1,CJGNUP,CJGNUU,RCIT,SW,POR,NREG,YY,SAREA,SM,VOL)     ! Chengji 2015-03-31
      USE M_PARAMS
      USE M_ET
      USE M_TIDE
      USE M_CTRL
...
C      IMPLICIT NONE
     ...
     2   X(NN),Y(NN),Z(NN)
      ...
      DIMENSION SW(NN),POR(NN),RCIT(NN),UM1(NN),SM(NN),VOL(NN)
...
C                                                                        BCTIME.......17300
  ...
  500 CONTINUE                                                           BCTIME.......17800
     ...
     3,NREG(IABS(I)),YY(IQP),SM(IABS(I))/VOL(IABS(I))*YY(IQP),TSEC)
C     3,NREG(IABS(I)),YY(IQP),SM(IABS(I))/SAREA(IQP),TSEC)  !TO200313
