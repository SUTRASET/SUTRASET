! THE MAJORITY OF THE FUNCTIONS ARE REQUIRED WHEN VAPOR FLOW IN POROUS MEDIA ARE CONSIDERED
! HOWEVER, SUTRASET DOES NOT TAKE IN TO ACCOUNT VAPOUR FLOW IN SOILS
...
!!! TO 190311 THIS FUNCTION IS COMMENTED AS IT IS NOT REQUIRED
