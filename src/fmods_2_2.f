...
C                                                                        ALLARR.........500
     ...
     1   SM,WMA,SMA,YY,SAREA,WMA1,SMA1,REK
...
C                                                                        FINDEF........1200
      ...
      MODULE M_TIDE
       IMPLICIT NONE
       DOUBLE PRECISION :: TASP,TANE,TPSP,TPNP,TM,RHOST,SC
       SAVE
      END MODULE M_TIDE
      
      MODULE M_ET
       IMPLICIT NONE
       DOUBLE PRECISION :: QET,UET,PET,UVM,PRDDN,OFSTDN,TMA,TMI,
...
!    PI
!    http://stackoverflow.com/questions/2157920/why-define-pi-4atan
...
!    MEAN POROSITY OF THE SOIL. THIS IS INTRODUCED TO AVERAGING FILM
!    PERMEABILITY THAT IS LESS SENSITIVE TO POROSITY(I.E. PERFILM)
      DOUBLE PRECISION,PARAMETER :: PORM=0.41D0
!    MEAN SOIL TEMPATURE, THIS IS INTRODUCED TO AVERAGING FILM 
!    PERMEABILITY THAT IS LESS SENSITIVE TO POROSITY (I.E. PERFILM)
      DOUBLE PRECISION,PARAMETER :: TPM=298.15D0
!      DOUBLE PRECISION,PARAMETER :: RHOW0=1.D3
      SAVE
      END MODULE M_PARAMS


!    WATER RETENTION PARAMETERS USED AT UNSAT
      MODULE M_SWCC
       IMPLICIT NONE
       DOUBLE PRECISION :: SWRES1,AA1,VN1,SWRES2,AA2,VN2,SWRES3,
     1 DLAM3,PSICB3,SWRES4,DLAM4,PSICB4,PSIC0,ECTO
       SAVE
      END MODULE M_SWCC
!    CONTROLLING SWITCHES
      MODULE M_CTRL
        IMPLICIT NONE
        INTEGER :: MET,MAR,MSR,MSC,MHT,MVT,MFT,MRK
        SAVE
      END MODULE  M_CTRL
!    SURFACE RESISTANCE PARAMETERS
      MODULE M_SURFR
        IMPLICIT NONE
        DOUBLE PRECISION :: TAL,EC,ETR,PSIP,COER
        SAVE
      END MODULE M_SURFR
!    AERODYNAMIC RESISTANCE
      MODULE M_AEROR
        IMPLICIT NONE
        DOUBLE PRECISION :: RAVT,RAVS,SWRAT
        SAVE
      END MODULE M_AEROR
